    ...
    <div id="bestdishes" class="container">
      ...
      <div class="slider">
      		    <ul class="slides">
                   ...
                   <div class="item2">
                          <img src="{{ asset ('images2/thumb2.jpg')}}" width="226" height="225" alt="sliderimg" class="wow flipInX"
                           data-wow-delay=".8s"> 
                          <h3>Pasta Pillus</h3>
                      </div> <!-- end of item-->
                      
                   <div class="item3">
                          <img src="{{ asset ('images2/thumb3.png')}}" width="226" height="225" alt="sliderimg" class="wow flipInX"
                           data-wow-delay=".8s"> 
                          <h3>Pasta Fusilli</h3>
                      </div> <!-- end of item-->
                  </li>
