...
<div class="container">
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control" required="required" name="image" id="image" value="{{$article->featured_image}}"></br>
        <img width="150px" src="{{asset('storage/'.$article->freatured_image)}}">
    </div>
</br></br>
