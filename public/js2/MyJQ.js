   ...
   $('#bookonline').find('input').focusin(function(){
	  ...
	  $('.myimage').click(function(){
	   ...
	   $($('.staff').find('li')).click(function(){
		   ...
		   $('.facebook').mouseenter(function(){$(this).attr('src','images2/fbhover.png')}).
		   mouseleave(function(){$(this).attr('src','images2/fb.png')}); 
		   
		   $('.twitter').mouseenter(function(){$(this).attr('src','images2/twitterhover.png')}).
		   mouseleave(function(){$(this).attr('src','images2/twitter.png')});
		   
		    $('.youtube').mouseenter(function(){$(this).attr('src','images2/youtubehover.png')}).
		   mouseleave(function(){$(this).attr('src','images2/youtube.png')});
		   
		   $('.google').mouseenter(function(){$(this).attr('src','images2//g+hover.png')}).
		   mouseleave(function(){$(this).attr('src','images2//g+.png')});
		   
		   $('.message').mouseenter(function(){$(this).attr('src','images2//messagehover.png')}).
		   mouseleave(function(){$(this).attr('src','images2//message.png')});
